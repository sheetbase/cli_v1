...
import { OAUHT2_CLIENT_SETTINGS, OAUTH2_URL_OPTS, GOOGLE_RC } from './google.config';
import { GoogleAccount, GoogleAccounts, GoogleAccountProfile } from '../user/user.type';
